...
impl Module {
    ...
    fn get_sampling_rate(&self) -> ::Result {
    ...
    fn get_trigger_delay(&self) -> ::Result {
    ...
    fn get_trigger_delay_ns(&self) -> ::Result {
    ...
    fn get_trigger_hyst(&self) -> ::Result {
    ...
    fn get_buffer_size(&self) -> ::Result {
